...
"""
Network implementation by Michael J. Dietz, 
adapted from https://gist.github.com/mjdietzx/881cd3e0f8836121226a04efb9e2ae18
"""
...
def ResNeXt50(**kwargs):
    return ResNeXt(num_classes=15)


if __name__ == '__main__':
    model = ResNeXt(num_classes=13)
    print(model)
